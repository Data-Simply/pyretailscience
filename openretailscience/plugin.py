"""Plugin management module for openretailscience."""
...
class PluginManager:
    """Manages plugins for openretailscience package."""
    ...
    def _load_all_plugins(self) -> None:
        ...
        failed_plugins = []
        try:
            for entry_point in entry_points(group="openretailscience.plugins"):
                try:
