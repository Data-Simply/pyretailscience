"""Integration tests for the HMLSegmentation class using PySpark."""
...
def test_hml_segmentation_with_pyspark(
    transactions_table,
    zero_value_customers,
):
    """Test HMLSegmentation with data fetched from PySpark.

    This parameterized test verifies that HMLSegmentation can be initialized
    and process data from PySpark using zero-value handling without throwing exceptions.
    """
