"""Integration tests for Revenue Tree Analysis with PySpark."""
...
def test_revenue_tree_with_pyspark(
    transactions_table,
    group_col,
    include_qty,
):
    """Test RevenueTree with data fetched from PySpark.

    This parameterized test verifies that RevenueTree can be initialized
    and process data from PySpark using different group columns
