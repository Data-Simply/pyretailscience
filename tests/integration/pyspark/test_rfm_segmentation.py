"""Integration tests for the RFMSegmentation class using PySpark."""
...
def test_rfm_segmentation_pyspark_executes(
    transactions_table,
    current_date,
    r_segments,
    f_segments,
    ...
    """Test RFMSegmentation with data fetched from PySpark.

    This parameterized test verifies that the RFMSegmentation class can be initialized
    and process data from PySpark using different current_date parameters without throwing exceptions.
    """
