"""Integration tests for Product Association Analysis with PySpark."""
...
def test_product_association_with_pyspark(
    transactions_table,
    target_item,
):
    """Test ProductAssociation with data fetched from PySpark.

    This parameterized test verifies that ProductAssociation can be initialized
    and process data from PySpark using target items without throwing exceptions.
    """
