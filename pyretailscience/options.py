...
class Options:
    ...
    def __init__(self) -> None:
        ...
        self._descriptions: dict[str, str] = {
            ...
            "plot.color.neutral": "Color for neutral values (e.g., values between thresholds)",
            "plot.color.difference": "Color for difference/comparison values (e.g., net amounts, deltas)",
