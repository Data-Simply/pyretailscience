...
class ProductAssociation:
    ...
    def __init__(
        ...
        number_of_combinations: int = SUPPORTED_COMBINATIONS,
        ...
        Args:
            ...
            number_of_combinations (int, optional): The number of products to consider in the association analysis.
              Defaults to 2.
    ...
    def _calc_association(  # (ignore complexity) - Excluded due to min_* arguments checks
        ...
        """
        if number_of_combinations != SUPPORTED_COMBINATIONS:
            raise ValueError("Only number_of_combinations=2 is currently supported.")
        ...
        unique_transactions = unique_transactions.mutate(
            product=ibis.expr.operations.Unnest(unique_transactions["products"]),
        ).drop("products")
        unique_transactions = unique_transactions.rename({"item": value_col})
